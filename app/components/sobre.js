            ...
            <div className="flex flex-col gap-5 px-4 py-5 md:px-10 md:py-10 relative bg-cover bg-center bg-no-repeat bg-[url('/images/sobre.webp')]">
                ...
                <div>
                    <div className="flex flex-col gap-2">
                        <h2 className="text-center font-lhcencoreregular font-medium text-3xl md:text-4xl xl:text-5xl text-white" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">A Encanto Grazing Food</h2>
                ...
                <div className="flex flex-col gap-2">
                    <h3 className="font-lhcencoreregular text-3xl xl:text-4xl text-center text-white font-medium" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">Depoimentos </h3>
