            ...
            <div className="max-w-screen-xl m-auto flex flex-col justify-between gap-5 items-center md:flex-row md:gap-10">
                <div className="w-full flex flex-col items-center gap-5 md:gap-10">
                    <div className="flex flex-col gap-3">
                        <h1 className="font-lhcencoreregular text-primary text-center text-3xl font-medium xl:text-5xl xl:text-center">Transforme uma simples <br/> cesta de café da manhã <br/> em um momento especial!</h1>
                        <p className="font-montserrat text-center text-primary text-sm tracking-wide xl:text-base xl:text-center">
                    ...
                    <a href="https://wa.me/5554991257469" target="_blank" className="w-full md:max-w-80">
                        <button className="w-full bg-secondary text-primary px-4 py-2 rounded-lg font-montserrat font-medium text-sm md:text-base flex items-center gap-1 justify-center shadow-md transform transition duration-300 ease-in-out hover:scale-110 md:max-w-80">
