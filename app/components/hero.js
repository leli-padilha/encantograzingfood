            ...
            <div className="max-w-screen-xl m-auto flex flex-col justify-between gap-5 items-center md:flex-row md:gap-10">
                <div className="w-full flex flex-col items-center gap-5 md:gap-10">
                    <div className="flex flex-col gap-3">
                        <h1 className="font-lhcencoreregular text-primary text-center text-3xl font-medium md:text-4xl xl:text-6xl xl:text-center">Transforme uma simples <br/> cesta de café da manhã <br/> em um momento especial!</h1>
                        <p className="font-montserrat text-center text-secondary text-sm tracking-wide md:text-xl xl:text-xl xl:text-center">
