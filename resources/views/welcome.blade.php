...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <header class="w-full bg-primary px-5 py-4">
            <div class="max-w-screen-xl m-auto flex justify-between items-center">
                ...
                <div class="flex flex-row gap-2">
                    ...
                    <p class="text-slate-50 font-montserrat font-medium text-base">(54) 99779-8998</p>
                </div>
            </div>
        </header>
        <!-- Header -->
        ...
        <main>
             <!-- Banners -->
            <section class="w-full pb-5 border-b border-primary">
                <div class="w-full">
            ...
            <section class="w-full px-4 py-4">
                <div class="max-w-screen-xl m-auto flex justify-between items-center sm:flex flex-col">
                    <div class="w-full flex flex-col gap-5">
                        ...
                        <button class="bg-secondary max-w-80 px-4 py-4 rounded-2xl font-montserrat font-medium text-base flex align-center gap-1 justify-center shadow-md transform transition duration-300 ease-in-out hover:scale-110">
                    ...
                    <div class="max-w-[635px] w-full">
                        <img class="w-full" src="{{ asset('storage/hero.png') }}" alt="">
                    </div>
                </div>
            </section>
            <!-- Hero -->
            ...
            <!-- Produtos -->
            <section class="w-full pt-5 p-0 " style="background-image: url({{ asset('storage/produtos/September2024/YZ7QVSbyf6eWOAslslH4.jpg') }})"> <!-- Section vai ter imagem de fundo -->
                <div class="max-w-screen-xl m-auto flex sm:flex flex-col px-4 py-4 bg-white rounded-t-xl gap-5"> <!-- fundo branco -->
                    <!-- Container titulo e subtitulo -->
                    <div class="w-full">
                        <h2 class="text-center font-antonio text-xl">
                            Produtos
                        </h2>
                        <h3 class="text-center font-lhcencoreregular text-2xl">Encanto Grazing Food</h3>
                    </div>
                    <!-- Container das miniaturas -->
                    <div class="w-full grid grid-cols-1 gap-4 sm:grid-cols-2">
                        
                        <!-- Container minatura -->
                        <div class="w-fit flex flex-col items-center shadow-md rounded-2xl lg:flex-row">
                            <div class="w-full h-full">
                                <img class="w-full h-full object-cover rounded-t-2xl lg:rounded-s-2xl" src="{{ asset('images/foundue_chamego.png') }}" alt="">
                            </div>
                            <div class="w-full pt-1 pb-4 px-4 flex flex-col gap-3">
                                <div class="flex justify-between items-center">
                                    <h3 class="font-lhcencoreregular text-2xl">Café Felicidade</h3>
                                    <div class="flex gap-1 ">
                                        ...
                                        <span class="font-antonio text-sm">Serve até 4</span>
                                    </div>
                                </div>
                                <div>
                                    <p class="font-montserrat text-base">Bandeja redonda em madeira, suco, sachês de café, pães, croassant, biscoitos, waffles, cookies, salada de frutas, iogurte, manteiga, geleia, doce de leite, uvas e morangos, queijos brie e fatiado, salame italiano e presunto. Flores ou eras aromáticas para decorar conforme disponibilidade do dia.</p>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="font-lhcencoreregular">R$250,00</span>
                                    <button class="flex items-center gap-2 bg-secondary px-4 py-2 rounded-2xl font-montserrat font-medium">
