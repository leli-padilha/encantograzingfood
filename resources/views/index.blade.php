    ...
    <body class="antialiased">
        ...
        <main>
            ...
            <section class="w-full px-4 py-4 md:px-10 md:py-10">
                <div class="max-w-screen-xl m-auto flex flex-col justify-between gap-5 items-center md:flex-row md:gap-10">
                    <div class="w-full flex flex-col gap-5 md:gap-10" data-aos="zoom-in-up">
                        ...
                        <a href="https://wa.me/5554991257469" target="_blank" class="w-full md:max-w-80">
                            <button class="w-full bg-secondary px-4 py-4 rounded-2xl font-montserrat font-medium text-base flex align-center gap-1 justify-center shadow-md transform transition duration-300 ease-in-out hover:scale-110 md:max-w-80">
            ...
            <section class="w-full h-full pt-5 p-0 md:pt-10  bg-center bg-no-repeat bg-cover" style="background-image: url('{{asset('images/teste.jpg')}}')"> <!-- Section vai ter imagem de fundo -->
                <div class="max-w-screen-xl m-auto flex sm:flex flex-col px-4 py-4 md:px-10 bg-white rounded-t-xl gap-5"> <!-- fundo branco -->
                    ...
                    <div class="w-full" data-aos="zoom-in">
                        ...
                        <h3 class="text-center font-lhcencoreregular font-semibold text-3xl">Encanto Grazing Food</h3>
                    </div>
                ...
                <div class="flex flex-col gap-5 px-4 py-5 md:px-10 md:py-10 relative bg-cover bg-center bg-no-repeat" style="background-image: url({{ asset('images/fundosobre.jpg') }})">
                    ...
                    <div>
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="max-w-3xl m-auto font-montserrat text-center text-white text-pretty tracking-wide" data-aos="zoom-in-up">A Encanto surgiu da necessidade de ter em nossa cidade uma opção de presente/comida afetiva, que fosse além de alimento, que entregasse amor, gratidão, pedido de desculpas, desejos de felicidades, enfim, que enchesse os olhos, a barriga e o coração de quem receber.</p>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
        ...
        <footer class="px-4 py-5" style="background-image: url({{asset('background.jpg')}})">
            <div class="flex flex-col gap-5" data-aos="zoom-in-up">
                <div class="max-w-56 m-auto pr-8" >
